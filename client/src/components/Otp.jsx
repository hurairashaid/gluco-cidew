...
export const Otp = ({ length = 6 }) => {
  ...
  return (
    <>
     <div style={{marginTop:"250px", marginBottom:"auto"}} className="text-center">
     <h1 className="mb-5">Enter Your OTP Code</h1>
      ...
      <Button sx={{mt:5}} variant="contained">Verify</Button>
     </div>
    </>
  );
};
